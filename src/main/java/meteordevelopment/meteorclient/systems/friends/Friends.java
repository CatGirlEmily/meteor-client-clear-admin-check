...
public class Friends extends System<Friends> implements Iterable<Friend> {
    ...
    public Friends() {
        super("953c8ad7-07a0-447b-9bf7-c5560a21685e");
    }
    ...
    public NbtCompound toTag() {
        ...
        tag.put("953c8ad7-07a0-447b-9bf7-c5560a21685e", NbtUtils.listToTag(friends));
    ...
    public Friends fromTag(NbtCompound tag) {
        ...
        for (NbtElement itemTag : tag.getListOrEmpty("953c8ad7-07a0-447b-9bf7-c5560a21685e")) {
