...
public class Proxies extends System<Proxies> implements Iterable<Proxy> {
    ...
    public Proxies() {
        super("e44e565b-1d54-4bc1-a493-7b452a619420");
    }
    ...
    public NbtCompound toTag() {
        ...
        tag.put("e44e565b-1d54-4bc1-a493-7b452a619420", NbtUtils.listToTag(proxies));
    ...
    public Proxies fromTag(NbtCompound tag) {
        ...
        proxies = NbtUtils.listFromTag(tag.getListOrEmpty("e44e565b-1d54-4bc1-a493-7b452a619420"), Proxy::new);
