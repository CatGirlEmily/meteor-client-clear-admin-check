...
public class Accounts extends System<Accounts> implements Iterable<Account<?>> {
    ...
    public Accounts() {
        super("3b275756-8585-41c8-b801-bea9e708914e");
    }
    ...
    public NbtCompound toTag() {
        ...
        tag.put("3b275756-8585-41c8-b801-bea9e708914e", NbtUtils.listToTag(accounts));
    ...
    public Accounts fromTag(NbtCompound tag) {
        MeteorExecutor.execute(() -> accounts = NbtUtils.listFromTag(tag.getListOrEmpty("3b275756-8585-41c8-b801-bea9e708914e"), tag1 -> {
